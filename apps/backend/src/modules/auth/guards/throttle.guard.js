        ...
        CustomThrottlerGuard_1.prototype.getTracker = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    ...
                    return [2 /*return*/, "".concat(req.ip, "-").concat(((_a = req.route) === null || _a === void 0 ? void 0 : _a.path) || req.url)];
                });
            });
        };
        CustomThrottlerGuard_1.prototype.getLimit = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var request, path;
                var _a;
                return __generator(this, function (_b) {
                    request = context.switchToHttp().getRequest();
                    path = ((_a = request.route) === null || _a === void 0 ? void 0 : _a.path) || request.url;
                    // Custom limits based on endpoint
                    if (path.includes('/auth/login')) {
                        return [2 /*return*/, 5]; // 5 requests per minute for login
                    }
                    if (path.includes('/auth/register')) {
                        return [2 /*return*/, 3]; // 3 requests per minute for registration
                    }
                    if (path.includes('/auth/forgot-password')) {
                        return [2 /*return*/, 2]; // 2 requests per minute for password reset
                    }
                    return [2 /*return*/, 30]; // Default: 30 requests per minute
                });
            });
        };
