...
var database_1 = require("@intelliwave/database");
var HealthController = function () {
    ...
    var HealthController = _classThis = /** @class */ (function () {
        ...
        HealthController_1.prototype.check = function () {
            return __awaiter(this, void 0, void 0, function () {
                var health, error_1, ping, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            health.services.database.error = error_1.message;
                            health.status = 'degraded';
                            return [3 /*break*/, 4];
                        case 4:
                            _a.trys.push([4, 6, , 7]);
                            return [4 /*yield*/, database_1.redisClient.ping()];
                        case 5:
                            ping = _a.sent();
                            health.services.redis.status = ping === 'PONG' ? 'healthy' : 'unhealthy';
                            return [3 /*break*/, 7];
                        case 6:
                            error_2 = _a.sent();
                            health.services.redis.status = 'unhealthy';
                            health.services.redis.error = error_2.message;
                            health.status = 'degraded';
                            return [3 /*break*/, 7];
                        case 7: return [2 /*return*/, health];
                    }
                });
            });
        };
        HealthController_1.prototype.ready = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, { status: 'ready', timestamp: new Date().toISOString() }];
                });
            });
        };
        HealthController_1.prototype.live = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, { status: 'alive', timestamp: new Date().toISOString() }];
                });
            });
        };
    ...
    (function () {
        ...
        _check_decorators = [(0, common_1.Get)(), (0, public_decorator_1.Public)(), (0, swagger_1.ApiOperation)({ summary: 'Health check endpoint' })];
        _ready_decorators = [(0, common_1.Get)('ready'), (0, public_decorator_1.Public)(), (0, swagger_1.ApiOperation)({ summary: 'Readiness probe' })];
        _live_decorators = [(0, common_1.Get)('live'), (0, public_decorator_1.Public)(), (0, swagger_1.ApiOperation)({ summary: 'Liveness probe' })];
        ...
        __esDecorate(_classThis, null, _live_decorators, { kind: "method", name: "live", static: false, private: false, access: { has: function (obj) { return "live" in obj; }, get: function (obj) { return obj.live; } }, metadata: _metadata }, null, _instanceExtraInitializers);
